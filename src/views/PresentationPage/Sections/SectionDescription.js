...
import descriptionStyle from "assets/jss/react-material/views/presentationSections/descriptionStyle";
        ...
        <GridContainer justify="center">
          <GridItem md={8} sm={8}>
            <h4 className={classes.description}>
              React Material is a Material React UI components with a fresh, new
