...
import styles from "assets/jss/react-material/components/headerLinksStyle";
...
export default function HeaderLinks(props) {
  ...
  return (
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <a
              href="https://demos.weenspace.com/react-material/#/documentation/tutorial?ref=mkpr-navbar"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          href="https://www.weenspace.com/product/react-material?ref=mkpr-navbar"
